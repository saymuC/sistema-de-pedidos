...
var
  ...
  DEFAULT_ERR_MSG = 'O ambiente atual nao suporta leitura interativa de TTY.',
  ...
  defaultOptions = {
    ...
    mask:               '*',
    limit:              [],
    limitMessage:       'Insira outro, por favor.$<( [)limit(])>',
    defaultInput:       '',
    trueValue:          [],
    falseValue:         [],
    caseSensitive:      false,
...
exports.questionEMail = function(query, options) {
  if (query == null) { query = 'Coloque o endereco de email: '; }
  /* eslint-disable key-spacing */
  return exports.question(query, margeOptions({
    ...
    limitMessage:       'Coloque um email válido por favor.',
    trueValue:          null,
    falseValue:         null
  }, options, {
    // -------- forced
...
exports.questionNewPassword = function(query, options) {
  ...
  var resCharlist, min, max,
    readOptions = margeOptions({
      ...
      hideEchoBack:       true,
      mask:               '*',
      limitMessage:       'Pode incluir: $<charlist>\n' +
                            'O minimo de caracteres é: $<length>',
      trueValue:          null,
      falseValue:         null,
      caseSensitive:      true
    }, options, {
  ...
  if (isNaN(min = parseInt(options.min, 10)) || typeof min !== 'number') { min = 3; }
  ...
  unmatchMessage = options.unmatchMessage != null ? options.unmatchMessage :
    'Senha digitada é difirente da orignal.' +
      ' Pressione somente a tecla Enter se quiser tentar novamente desde o início.';
...
function _questionNum(query, options, parser) {
  ...
  exports.question(query, margeOptions({
    // -------- default
    limitMessage:       'Coloque um número válido por favor..'
  }, options, {
    // -------- forced
    limit:              getValidValue,
    cd:                 false
...
exports.questionPath = function(query, options) {
  ...
  var error = '',
    ...
    readOptions = margeOptions({
      // -------- default
      hideEchoBack:       false,
      limitMessage:       '$<error(\n)>Coloque um caminho valido por favor.' +
                            '$<( Min:)min>$<( Max:)max>',
      history:            true,
      cd:                 true
    }, options, {
      ...
      limit: function(value) {
        ...
        function mkdirParents(dirPath) {
          dirPath.split(/\/|\\/).reduce(function(parents, dir) {
            ...
            if (!fs.existsSync(path)) {
              ...
              throw new Error('Nenhum diretório já existe: ' + path);
            }
            return parents;
          }, '');
        }
        ...
        try {
          ...
          if (!options.hasOwnProperty('exists') && !exists ||
            ...
            error = (exists ? 'Ja existe' : 'Não existe tal arquivo ou diretório') +
              ': ' + validPath;
            return false;
          }
  ...
  if (query == null) { query = 'Caminho de entrada (você pode usar "cd" e "pwd"): '; }
...
exports.promptCL = function(commandHandler, options) {
  ...
  var readOptions = margeOptions({
      // -------- default
      hideEchoBack:       false,
      limitMessage:       'Comando chamado não esta disponível.',
      caseSensitive:      false,
      history:            true
    }, options),
    //   -------- forced
...
exports.promptCLLoop = function(commandHandler, options) {
  ...
  var readOptions = margeOptions({
      // -------- default
      hideEchoBack:       false,
      limitMessage:       'Comando chamado não esta disponivel',
      caseSensitive:      false,
      history:            true
    }, options),
    //   -------- forced
...
function _keyInYN(query, options, limit) {
  var res;
  if (query == null) { query = 'Tem certeza? '; }
...
exports.keyInPause = function(query, options) {
  ...
  if ((!options || options.guide !== false) && (query += '')) {
    query = query.replace(/\s+$/, '') + ' (Aperte qualquer tecla)';
  }
  /* eslint-disable key-spacing */
...
exports.keyInSelect = function(items, query, options) {
  ...
  if (!Array.isArray(items) || !items.length || items.length > 60) {
    throw '`items` deve ser um array (tamanho máximo: 60).';
  }
  ...
  if (!options || options.cancel !== false) {
    ...
    display += '[0] ' +
      (options && options.cancel != null && typeof options.cancel !== 'boolean'
        ? (options.cancel + '').trim() : 'CANCELAR') + '\n';
  }
  readOptions.limit = keylist;
  display += '\n';

  if (query == null) { query = 'Escolha desta lista: '; }
  if ((query += '')) {
